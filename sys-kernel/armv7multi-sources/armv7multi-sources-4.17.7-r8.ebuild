...
PATCHES=(
	"${FILESDIR}/4.17/0001-ARM-DTS-imx6qdl-udoo-enable-uart4-serial-interface-f.patch"
	"${FILESDIR}/4.17/0002-ARM-dts-driver-imx6-udooqdl-add-arduino-manager-driv.patch"
)
