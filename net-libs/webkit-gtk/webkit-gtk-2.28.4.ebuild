...
IUSE="aqua clang +egl +geolocation gles2-only gnome-keyring +gstreamer gtk-doc +introspection +jpeg2k +jumbo-build libnotify lto +opengl seccomp spell wayland +X"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/2.28.3-fix-arm-non-unified-build.patch # bug 704194
	eapply "${FILESDIR}/${PN}-2.24.2-add-gcc-lto-pragma-fix.patch"
	eapply "${FILESDIR}/${PN}-2.26.4-force-thumb-for-clang-on-armv7.patch"
