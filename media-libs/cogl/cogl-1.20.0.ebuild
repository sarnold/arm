...
inherit clutter flag-o-matic gnome2 multilib virtualx
...
src_prepare() {
	...
	# can't find its own libs during install
#	use gstreamer && sed -i \
#			-e "s|avoid-version -no-undefined|avoid-version|" \
#			cogl-gst/Makefile.am cogl-gst/Makefile.in
